    ...
    <header className="fixed top-0 left-0 w-full bg-gray-200 text-gray-800 z-40">
      ...
      >
        <div className="flex flex-col p-4">
          ...
          <Link to="/student/supervisors" className="flex items-center gap-2 p-2 text-lg hover:bg-gray-300">
            <FaUsers size={20} className="text-green-500" /> Supervisors
          </Link>
          <Link to="/student/my-group" className="flex items-center gap-2 p-2 text-lg hover:bg-gray-300">
            <FaUser size={20} className="text-purple-500" /> My Group
          </Link>
          <Link to="/student/groups" className="flex items-center gap-2 p-2 text-lg hover:bg-gray-300">
