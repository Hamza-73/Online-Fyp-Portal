...
import { AuthContext } from '../../context/AuthApis.jsx'; // Import the Student context
...
export default function EditStudentProfile() {
    ...
    const { getStudentProfile } = useContext(AuthContext); // Access fetching function from context
    const { editStudentProfile } = useContext(StudentContext); // Access edit function from context
