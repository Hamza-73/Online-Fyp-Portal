...
const AdminNav = ({ userData, onLogout, isSidebarOpen, toggleSidebar }) => {
    ...
    <header className="fixed top-0 left-0 w-full bg-maroon z-40">
      ...
      >
        <div className="flex flex-col p-4">
          ...
          <Link to="/admin/student-list" className="p-2 text-lg hover:bg-gray-200">
            Students
          </Link>
          <Link to="/admin/supervisor-list" className="p-2 text-lg hover:bg-gray-200">
            Supervisors
          </Link>
          <button
