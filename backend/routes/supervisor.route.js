...
const { getSupervisors, getProfile , editSupervisorProfile, deleteSupervisor, viewRequests, acceptRequest, profile, rejectRequest} = require('../controllers/supervisor.controller');
