...
const { getSupervisors, getProfile , editSupervisorProfile, deleteSupervisor, viewRequests, acceptRequest, profile, rejectRequest, getMyGroups, makeAnncouncement, registerFromFile, reviewDocument, setDeadline, scheduleViva} = require('../controllers/supervisor.controller');
